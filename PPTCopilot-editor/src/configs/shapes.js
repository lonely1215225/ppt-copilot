...
export const SHAPE_PATH_FORMULAS = {
    ["roundRect" /* ShapePathFormulasKeys.ROUND_RECT */]: {
        editable: true,
        defaultValue: 0.125,
        range: [0, 0.5],
        relative: 'left',
    ...
    ["cutRectDiagonal" /* ShapePathFormulasKeys.CUT_RECT_DIAGONAL */]: {
        editable: true,
        defaultValue: 0.2,
        range: [0, 0.9],
        relative: 'right',
    ...
    ["cutRectSingle" /* ShapePathFormulasKeys.CUT_RECT_SINGLE */]: {
        editable: true,
        defaultValue: 0.2,
        range: [0, 0.9],
        relative: 'right',
    ...
    ["cutRectSameSide" /* ShapePathFormulasKeys.CUT_RECT_SAMESIDE */]: {
        editable: true,
        defaultValue: 0.2,
        range: [0, 0.5],
        relative: 'left',
    ...
    ["roundRectDiagonal" /* ShapePathFormulasKeys.ROUND_RECT_DIAGONAL */]: {
        editable: true,
        defaultValue: 0.125,
        range: [0, 1],
        relative: 'left',
    ...
    ["roundRectSingle" /* ShapePathFormulasKeys.ROUND_RECT_SINGLE */]: {
        editable: true,
        defaultValue: 0.125,
        range: [0, 1],
        relative: 'right',
    ...
    ["roundRectSameSide" /* ShapePathFormulasKeys.ROUND_RECT_SAMESIDE */]: {
        editable: true,
        defaultValue: 0.125,
        range: [0, 0.5],
        relative: 'left',
    ...
    ["cutRoundRect" /* ShapePathFormulasKeys.CUT_ROUND_RECT */]: {
        editable: true,
        defaultValue: 0.125,
        range: [0, 0.5],
        relative: 'left',
    ...
    ["message" /* ShapePathFormulasKeys.MESSAGE */]: {
    ...
    ["roundMessage" /* ShapePathFormulasKeys.ROUND_MESSAGE */]: {
        formula: (width, height) => {
    ...
    ["ringRect" /* ShapePathFormulasKeys.RING_RECT */]: {
        editable: true,
        defaultValue: 0.25,
        range: [0.1, 0.45],
        relative: 'left',
    ...
    ["plus" /* ShapePathFormulasKeys.PLUS */]: {
        editable: true,
        defaultValue: 0.25,
        range: [0.1, 0.9],
        relative: 'center',
    ...
    ["triangle" /* ShapePathFormulasKeys.TRIANGLE */]: {
        editable: true,
        defaultValue: 0.5,
        range: [0, 1],
        relative: 'left',
        getBaseSize: (width, height) => width,
        formula: (width, height, value) => {
            const vertex = width * value;
            return `M ${vertex} 0 L 0 ${height} L ${width} ${height} Z`;
        }
    },
    ["parallelogramLeft" /* ShapePathFormulasKeys.PARALLELOGRAM_LEFT */]: {
        editable: true,
        defaultValue: 0.25,
        range: [0, 0.9],
        relative: 'left',
    ...
    ["parallelogramRight" /* ShapePathFormulasKeys.PARALLELOGRAM_RIGHT */]: {
        editable: true,
        defaultValue: 0.25,
        range: [0, 0.9],
        relative: 'right',
    ...
    ["trapezoid" /* ShapePathFormulasKeys.TRAPEZOID */]: {
        editable: true,
        defaultValue: 0.25,
        range: [0, 0.5],
        relative: 'left',
    ...
    ["bullet" /* ShapePathFormulasKeys.BULLET */]: {
        editable: true,
        defaultValue: 0.2,
        range: [0, 1],
        relative: 'top',
    ...
    ["indicator" /* ShapePathFormulasKeys.INDICATOR */]: {
        editable: true,
        defaultValue: 0.2,
        range: [0, 0.9],
        relative: 'right',
    ...
    },
    {
        ...
        children: [
            ...
            },
            {
                ...
                pathFormula: "triangle" /* ShapePathFormulasKeys.TRIANGLE */,
            ...
            },
            {
                ...
                pathFormula: "parallelogramLeft" /* ShapePathFormulasKeys.PARALLELOGRAM_LEFT */,
                pptxShapeType: 'parallelogram',
            },
            {
                viewBox: [200, 200],
                path: 'M 0 0 L 150 0 L 200 200 L 50 200 L 0 0 Z',
                pathFormula: "parallelogramRight" /* ShapePathFormulasKeys.PARALLELOGRAM_RIGHT */,
            },
            {
                viewBox: [200, 200],
                path: 'M 50 0 L 150 0 L 200 200 L 0 200 L 50 0 Z',
                pathFormula: "trapezoid" /* ShapePathFormulasKeys.TRAPEZOID */,
            ...
            },
            {
                ...
                pathFormula: "bullet" /* ShapePathFormulasKeys.BULLET */,
            },
            {
                viewBox: [200, 200],
                path: 'M 200 100 L 150 0 L 0 0 L 50 100 L 0 200 L 150 200 L 200 100 Z',
                pathFormula: "indicator" /* ShapePathFormulasKeys.INDICATOR */,
            },
            {
                viewBox: [200, 200],
            ...
            },
            {
                ...
                pathFormula: "L" /* ShapePathFormulasKeys.L */
            },
            {
                viewBox: [200, 200],
                path: 'M0 0 L200 0 L200 200 L0 200 L0 0 Z M50 50 L50 150 L150 150 L150 50 Z',
                pathFormula: "ringRect" /* ShapePathFormulasKeys.RING_RECT */,
            },
            {
                viewBox: [200, 200],
            ...
            },
            {
                ...
                pathFormula: "plus" /* ShapePathFormulasKeys.PLUS */,
            },
            {
                viewBox: [200, 200],
            ...
            },
            {
                ...
                pathFormula: "message" /* ShapePathFormulasKeys.MESSAGE */,
            },
            {
                viewBox: [200, 200],
                ...
                pathFormula: "roundMessage" /* ShapePathFormulasKeys.ROUND_MESSAGE */,
            },
            {
                viewBox: [200, 200],

...
import { getRectRotatedRange, uniqAlignLines } from '@/utils/element';
...
export default (elementList, alignmentLines, canvasScale) => {
    ...
    const dragElement = (e, element) => {
        ...
        for (const el of elementList.value) {
            ...
            const horizontalCenterLine = { value: centerX, range: [left, right] };
            const leftLine = { value: left, range: [top, bottom] };
            const rightLine = { value: right, range: [top, bottom] };
            const verticalCenterLine = { value: centerY, range: [top, bottom] };

...
export default () => {
     ...
     * @param text 文本
     */
    const createTextElementFromClipboard = (text) => {
        createTextElement({
            left: 0,
            top: 0,
            width: 600,
     ...
     */
    const pasteTextClipboardData = (text, options) => {
...
//# sourceMappingURL=usePasteTextClipboardData.js.map